...
cellPosition : Size -> Cell -> Index -> List (Attribute Msg)
cellPosition size cell idx =
    [ style "top" "0"
    , style "left" "0"
...
viewDead size idx c =
    div (deadDisplay :: (List.concat [ cellPosition size c idx, cellSizeStyle size ]))
